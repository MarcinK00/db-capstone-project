...
CREATE TABLE `bookings` (
  ...
  CONSTRAINT `stuffID` FOREIGN KEY (`stuffID`) REFERENCES `stuff` (`stuffID`)
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `itemID` FOREIGN KEY (`itemID`) REFERENCES `menu` (`itemID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-15 20:11:10
